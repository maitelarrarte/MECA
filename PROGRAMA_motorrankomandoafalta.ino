...
void loop() 
{
  ...
  int steer=0;
   ...
   if (Serial.available() > 0) {
    ...
    hasieraf=millis()  ;  
      for (int i=0; i<=4000; i++){   //4 segungo aurrea
      digitalWrite(23,LOW);
      steer=0 ;
      speed=200 ;
   //   Comunication(steer,speed);
    ...
    for (int i=0; i<=4000; i++){   //4 segungo atzea
    digitalWrite(22,LOW);
    steer=0;
    speed=-200;
    //  Comunication(steer,speed);
    ...
    for (int i=0; i<=4000; i++){   //4 segungo eskuinea intermitentekin
    steer=1000;
    speed=200;
  //  Comunication(steer,speed);
    if (i % 100==0){
    ...
    for (int i=0; i<=4000; i++){   //4 segungo ezkerrea intermitentekin
    steer=-1000;
    speed=200;
  //  Comunication(steer,speed);
    if (i % 100==0){
